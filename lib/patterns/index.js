...
import { MeridianPattern, config as meridianConfig } from './core/MeridianLines'
...
export function createPattern(key, width, height, config, clearRadius) {
  switch (key) {
    ...
    case 'meridian':
      return new MeridianPattern(width, height, clearRadius, config)
    case 'hexagon':
...
export { MeridianPattern } from './core/MeridianLines'
