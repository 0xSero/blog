...
import { CellularNetwork, config as cellularConfig } from './core/CellularNetwork'
...
export function createPattern(key, width, height, config, clearRadius) {
  switch (key) {
    ...
    case 'cellular':
      return new CellularNetwork(width, height, clearRadius, config)
    default:
...
export { CellularNetwork } from './core/CellularNetwork'
