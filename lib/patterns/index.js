...
import { OrbitingParticles, config as particlesConfig } from './core/OrbitingParticles'
...
export function createPattern(key, width, height, config, clearRadius) {
  switch (key) {
    ...
    case 'particle':
      return new OrbitingParticles(width, height, clearRadius, config)
    default:
...
export { OrbitingParticles } from './core/OrbitingParticles'
