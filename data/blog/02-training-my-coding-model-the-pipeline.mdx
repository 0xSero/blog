---
title: 'Part 2: Training My Own Coding Model — The SFT and DPO Pipeline'
date: '2026-01-17'
...
The model outputs `</think>` blocks it needs to hide. Training data must have included my private thought process. DPO alignment would fix this.
...
- DPO alignment on the preference pairs
